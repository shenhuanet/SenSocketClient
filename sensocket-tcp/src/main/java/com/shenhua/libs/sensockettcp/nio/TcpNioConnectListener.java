...
public interface TcpNioConnectListener {
     ...
     */
    void onConnectSuccess(TcpNioReadWriteProcessor mSocketProcessor, SocketChannel socketChannel) throws IOException;
     ...
     * @param mSocketProcessor 读写处理器
     */
    void onConnectFailed(TcpNioReadWriteProcessor mSocketProcessor);
